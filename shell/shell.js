/* =========================================================================
   ...
   En el Dashboard, además, pinta una grilla de accesos rápidos donde haya
   <div id="module-accesos">.
   ========================================================================= */
...
const MODULE_ICONS = {
  ...
  proveedores:    '<svg viewBox="0 0 24 24"><path d="M3 21V8l6-4 6 4v13"/><path d="M15 21V11h6v10"/><path d="M7 12h2M7 16h2M18 15h1"/></svg>',
  ...
  cierre:         '<svg viewBox="0 0 24 24"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4z"/></svg>',
...
async function mount() {
  ...
  // Grilla de accesos rápidos (si la página la pide, típicamente el Dashboard)
